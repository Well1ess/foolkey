...
public class YYFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public YYFragmentTabHost(Context context) {
    ...
    public YYFragmentTabHost(Context context, AttributeSet attrs) {
        super(context, attrs);
