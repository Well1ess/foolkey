package com.example.a29149.yuyuan.ModelTeacher.TeacherMain;
...
public class MainTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFragmentTabHost.addTab(tabSpec0, TeacherScoreMainFragment.class, null);//修改了，与学生界面不同
        ...
        mPublishRewardStudent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainTeacherActivity.this, PublishRewardDescribeStudentActivity.class);
        ...
        mPublishAskStudent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(intent);
                Toast.makeText(MainTeacherActivity.this, "发布问题", Toast.LENGTH_SHORT).show();
            }
        });
    }
