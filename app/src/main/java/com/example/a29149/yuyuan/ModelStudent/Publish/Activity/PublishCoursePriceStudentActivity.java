...
public class PublishCoursePriceStudentActivity extends AbstractActivity implements View.OnClickListener {

    private ImageView mReturn;
    private ImageView mGo;

    private EditText mRewardPrice;//课程价格
    ...
    private void goNext() {
        ...
        else
        {
            ...
            Intent intent = new Intent(PublishCoursePriceStudentActivity.this, PublishRewardOptionsStudentActivity.class);
