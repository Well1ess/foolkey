 ...
 * Created by GR on 2017/5/23.
 */
public class GetOrderBuyRewardAsTeacherByOrderStatesController extends AbstractControllerTemplate {
...
//    private String courseTypeEnum;
    ...
    //课程信息DTOS
    protected List<RewardDTO> rewardDTOS;
    ...
    protected void afterHandle(String s) {
        ...
        try {
            ...
            if (resultFlag.equals("success")) {
                ...
                log.d(this, jsonObject.getString("rewardDTOS"));

                //判断传来的参数是否是空
                if (jsonObject.getString("orderBuyCourseDTOS") == null || jsonObject.getString("studentDTOS") == null || jsonObject.getString("rewardDTOS") == null) {
                ...
                //处理参数：rewardDTOS（课程信息DTO）
                type = new com.google.gson.reflect.TypeToken<List<RewardDTO>>() {
                }.getType();
                this.rewardDTOS = new Gson().fromJson(jsonObject.getString("rewardDTOS"), type);
